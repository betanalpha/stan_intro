...
concrete representations and computation, before discuss many
...
either discrete and continuous.
...
The fundamental object in probability theory are probability distributions
...
For example, if $\bt$ took values on the real like, $\Theta = \RR$, then 
...
be true that others.  Probabilities themselves are bounded between 
