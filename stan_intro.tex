...
so does the concentration of measure.
}
...
simple cases MAP estimators constructed from probability density functions
...
distributions, and only then if an appropriate sample space
can be found.  
...
optimization over a space of approximating distributions.
...
\end{tikzpicture}
\caption{Typically different elements of the variational family
...
in both the numerator and denominator and cancels when
...
chains to converge then not all of the chains will look 
...
The big world is much too ungainly to even be well-defined in practice, 
...
with any information contained in the measurement to obtain a \emph{posterior
...
likelihood implicitly defines any information contained in a measurement and 
