...
\emph{any} function $f : \Theta \rightarrow \RR$ as \textbf{any
...
estimate than those with low variance.  \textbf{Moreover, because
the MCSE doesn't depend on the dimensionality of the sample
space it scales particularly well to high-dimensional problems.}
...
the structure of the typical set a priori.  \textbf{As we move into
higher-dimensions, concentration of measure makes this an even 
more delicate process and any auxiliary distribution that isn't
