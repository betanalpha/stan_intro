...
results such as Central Limit Theorems.}
...
pathological region: as the chain hovers around the pathological
region the estimators are drawn down, almost as if the Markov 
chain were exploring the pathological region.  Eventually the Markov 
chain escapes to explore the rest of the typical set and the estimator 
bias begins to increase again (Figure \ref{fig:pathological exploration}).  
